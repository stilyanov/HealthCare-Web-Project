...
public class UserRegisterDTO {
    ...
    @Size(min = 5, max = 20, message = "First Name length must be between 3 and 20 characters!")
    private String firstName;

    @NotNull(message = "Last Name cannot be empty!")
    @Size(min = 5, max = 20, message = "Last Name length must be between 3 and 20 characters!")
