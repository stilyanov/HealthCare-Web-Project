        ...
        return http
                .authorizeHttpRequests(authorizeRequest ->
                        authorizeRequest
                                ...
                                .requestMatchers("/doctors/change-password","/appointments/delete/**", "/patient-result/add/**").hasRole("DOCTOR")
                                .requestMatchers("/patient-result/my-results").hasRole("PATIENT")
                                .anyRequest()
                                .authenticated()
                )
                .formLogin(formLogin ->
